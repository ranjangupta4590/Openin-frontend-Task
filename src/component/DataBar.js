    ...
    return (
        <div className='grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-3'>
            ...
            <div id="rev-box" className="data">
                <img src={revenue} width={45} height={45} id="card-icon" alt="revenue" />
                <div className="mt-2 ">
                    <p className="text-sm text-left ">Total Revenues</p>
                    
                    <div className="flex justify-between mt-1">
                        <h2 className="text-xl font-bold">$ 2,129,430</h2>
                        <button className="bg-[#E9F9EB] rounded-xl p-1 text-xs font-semibold text-[#3CC952]">
                            +2.5%
                        </button>
                    </div>
                </div>
            ...
            <div id="trans-box" className="data ">
                ...
                <div className="mt-2 ">
                    <p className="text-sm text-left">Total Transaction</p>
                    <div className="flex justify-between mt-1">
            ...
            <div id="like-box" className="data ">
                ...
                <div className="mt-2 ">
                    <p className="text-sm text-left">Total Likes</p>
                    <div className="flex justify-between mt-1">
            ...
            <div id="user-box" className="data ">
                ...
                <div className="mt-2 ">
                    <p className="text-sm text-left">Total Users</p>
                    <div className="flex justify-between mt-1">
                        <h2 className="text-xl font-bold">9,721</h2>
                        <button className="bg-[#E9F9EB] rounded-xl p-1 text-xs font-semibold text-[#3CC952]">
                            +4.2%
